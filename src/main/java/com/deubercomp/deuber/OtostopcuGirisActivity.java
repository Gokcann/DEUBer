...
public class OtostopcuGirisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otostopcu_giris);
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(kullanici!=null){
                    Intent intent = new Intent(OtostopcuGirisActivity.this, OtostopcuHaritaActivity.class);
        ...
        vKayit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                vAuth.createUserWithEmailAndPassword(email,sifre).addOnCompleteListener(OtostopcuGirisActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Toast.makeText(OtostopcuGirisActivity.this, "KAYIT HATASI", Toast.LENGTH_SHORT).show();
                        }//eger islem tamamlanirsa aktif_kullanici_db adinda bir kok olusturuyor
                        else {
                            String kullanici_id = vAuth.getCurrentUser().getUid();
                            DatabaseReference aktif_kullanici_db = FirebaseDatabase.getInstance().getReference().child("Kullanici").child("Otostopcu").child(kullanici_id);
        ...
        vGiris.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String email = vEmail.getText().toString();
                final String sifre = vSifre.getText().toString();
                vAuth.signInWithEmailAndPassword(email,sifre).addOnCompleteListener(OtostopcuGirisActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            Toast.makeText(OtostopcuGirisActivity.this, "GIRIS HATASI", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
